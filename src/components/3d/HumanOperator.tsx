  ...
  return (
    ...
    >
      ...
      <group position={[0, isStanding ? 0.75 : 0.48, isStanding ? 0.1 : 0]}>
        ...
        {/* Arms with conditional rotation for Inspection state */}
        {[-1, 1].map((side) => {
        ...
        {/* Legs with conditional posing for Standing vs Sitting */}
        {[-1, 1].map((side) => (
